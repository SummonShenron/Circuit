...
export type Kind = "llm" | "api" | "condition" | "transform" | "variable" | "repeat_until" | "for_each" | "github_repository" | "resend_email" | "google_drive" | "schedule" | "google_drive_update" | "weather_forecast" | "news_headlines" | "google_sheets_append" | "csv_create" | "rss_feed" | "webhook_post" | "http_response" | "mongodb" | "gmail_send" | "reddit_headlines" | "google_calendar" | "github_action" | "job_search" | "erragent";
...
export type RunResult = { context: { inputs: Record<string, unknown>; outputs: Record<string, unknown>; logs: string[]; errors: string[] }; trace: Array<{ node_id: string; node_label: string; status: "started" | "completed" | "failed"; message: string; timestamp: string }> };
...
export type WorkflowInput = { key: string; label: string; type: "string" | "number" | "boolean"; required: boolean };
