...
import { CheckCircle2, Clock3, CloudSun, FilePlus2, GitBranch, KeyRound, Link2, MoreHorizontal, Play, Search, Trash2, Workflow, X, XCircle } from "lucide-react";
...
export default function Dashboard({ onOpen, onCreate }: DashboardProps) {
  ...
  const startTutorial = async (tutorial: "chat-assistant" | "routing" | "weather-briefing" | "rag-retriever", workflowName: string) => {
    setTutorialNotice("");
  ...
  return <main className="dashboard-shell">
    ...
    <div className="dashboard-mascot"><PatchyEmptyState tab="open" compact hints={DASHBOARD_HINTS} hintIntervalMs={10_000} /></div>
  </main>;
}